...
library Events {
    ...
    event FinanceModuleWhitelisted(
        address indexed financeModule,
        bool indexed whitelisted,
        uint256 timestamp
    );
    ...
    event FinancePoolDeployed(
        uint256 indexed profileId,
        uint256 indexed pubId,
        address indexed financePool,
        uint256 timestamp
    );
    ...
    event CollectedCollectorAndPrice(
     ...
     *
     * @param hub The PoPPHub contract address used.
     * @param timestamp The current block timestamp.
     */
    ...
    /**
     * @dev Emitted when the user wants to enable or disable follows in the `PoPPPeriphery`.
     *
    ...
    /**
     * @dev Emitted when the metadata associated with a profile is set in the `PoPPPeriphery`.
     *
    ...
    event ProfileType(uint256 indexed profileId, uint8 indexed profileType);
}
